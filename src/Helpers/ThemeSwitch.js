...
const ThemeSwitch = () => {
  ...
  return (
    <div style={{position: "fixed", zIndex:"3", top:"-15px", left:"5px"}}>
      <input defaultChecked onClick={toggleLightMode} type="checkbox" id="lightmode-toggle" className={styles.Input} />
      <label htmlFor="lightmode-toggle" className={styles.Labela}>
        <svg
          version="1.1"
